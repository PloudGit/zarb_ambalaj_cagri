		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ambalaj Portali Çağrı Uygulaması",
									"targetURL": "#comappabdiibrahimzarbambalajcagri-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappabdiibrahimzarbambalajcagri-display": {
								"semanticObject": "comappabdiibrahimzarbambalajcagri",
								"action": "display",
								"description": "Ambalaj Portali Çağrı Uygulaması",
								"title": "Ambalaj Portali Çağrı Uygulaması",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.abdiibrahim.zarbambalajcagri",
									"url": sap.ui.require.toUrl("com/app/abdiibrahim/zarbambalajcagri")
								}
							}
						}
					}
